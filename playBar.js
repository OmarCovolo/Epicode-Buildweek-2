...
const cardLarge1 = async function () {
  try {
    let res = await fetch(
      " https://striveschool-api.herokuapp.com/api/deezer/album/300062"
    );
    console.log(res);
    if (res.ok) {
      let dataLong = await res.json();
...
const cardLarge2 = async function () {
  try {
    let res = await fetch(
      " https://striveschool-api.herokuapp.com/api/deezer/album/662259"
    );
    console.log(res);
    if (res.ok) {
      let dataLong = await res.json();
...
const cardLarge3 = async function () {
  try {
    let res = await fetch(
      " https://striveschool-api.herokuapp.com/api/deezer/album/108706862"
    );
    console.log(res);
    if (res.ok) {
      let dataLong = await res.json();
...
const cardLarge4 = async function () {
  try {
    let res = await fetch(
      " https://striveschool-api.herokuapp.com/api/deezer/album/258963"
    );
    console.log(res);
    if (res.ok) {
      let dataLong = await res.json();
...
const cardLarge5 = async function () {
  try {
    let res = await fetch(
      " https://striveschool-api.herokuapp.com/api/deezer/album/247385"
    );
    console.log(res);
    if (res.ok) {
      let dataLong = await res.json();
...
const cardHi = async function () {
  try {
    let res = await fetch(
      " https://striveschool-api.herokuapp.com/api/deezer/album/155994342"
    );
    console.log(res);
    if (res.ok) {
      let dataLong = await res.json();
...
const cardHi1 = async function () {
  try {
    let res = await fetch(
      " https://striveschool-api.herokuapp.com/api/deezer/album/364187517"
    );
    console.log(res);
    if (res.ok) {
      let dataLong = await res.json();
...
const cardHi2 = async function () {
  try {
    let res = await fetch(
      " https://striveschool-api.herokuapp.com/api/deezer/album/126328"
    );
    console.log(res);
    if (res.ok) {
      let dataLong = await res.json();
...
const cardHi3 = async function () {
  try {
    let res = await fetch(
      " https://striveschool-api.herokuapp.com/api/deezer/album/10304782"
    );
    console.log(res);
    if (res.ok) {
      let dataLong = await res.json();
...
const cardHi4 = async function () {
  try {
    let res = await fetch(
      " https://striveschool-api.herokuapp.com/api/deezer/album/108563"
    );
    console.log(res);
    if (res.ok) {
      let dataLong = await res.json();
...
function playMusic(song, title, artist) {
  ...
  audio.addEventListener("loadedmetadata", () => {
    document.querySelector(".totalDuration").innerHTML = `${updateTime(
      audio.duration
    )}`;
    ...
    setInterval(() => {
      if (
        volume.offsetWidth > (volumeRange.offsetWidth * 50) / 100 &&
        volume.offsetWidth !== 0
      ) {
        document.querySelector(".bi-volume-up").style.display = "block";
        document.querySelector(".bi-volume-up").onclick = () => {
          (audio.volume = 0), (volume.style.width = "0");
        };
        ...
        document.querySelector(".bi-volume-down").onclick = () => {
          (audio.volume = 0), (volume.style.width = "0");
        };
        document.querySelector(".bi-volume-mute").style.display = "none";
      }
      if (volume.offsetWidth === 0) {
        ...
        document.querySelector(".bi-volume-mute").onclick = () => {
          (audio.volume = 0), (volume.style.width = "0");
        };
        document.querySelector(".bi-volume-up").style.display = "none";
        document.querySelector(".bi-volume-down").style.display = "none";
    ...
    setInterval(() => {
      ...
      document.querySelector(".current-time").innerHTML = `${updateTime(
        audio.currentTime
      )}`;
      player.style.width = `${Math.round(
        (audio.currentTime / audio.duration) * playerRange.offsetWidth
      )}px`;
    }, 10);
  });
}
